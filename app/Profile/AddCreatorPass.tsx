        ...
        return (
            <ThemedView style={CreatorPassStyles.Container}>
                <View style={CreatorPassStyles.TopBar}>
                    <TouchableOpacity
                        style={CreatorPassStyles.BackIcon}>
                        <Image
                ...
                <View style={CreatorPassStyles.Centered}>
                    ...
                    <TouchableOpacity style={CreatorPassStyles.button}>
                        <Text style={{ color: "#000", fontFamily: 'Inter-SemiBold' }}>Add Creator pass</Text>
                    </TouchableOpacity>

                    <ThemedText style={CreatorPassStyles.Text}>By enabling the Creator Pass, you agree to offer all your</ThemedText>
                    <ThemedText style={CreatorPassStyles.Text}>paid content to users who subscribe to your pass at the</ThemedText>
                    <ThemedText style={CreatorPassStyles.Text}>price you set. You&apos;ll earn revenue from each subscription</ThemedText>
                    <ThemedText style={CreatorPassStyles.Text}>after platform fees and taxes.</ThemedText>
                </View>
